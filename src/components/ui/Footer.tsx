      ...
      <footer className="footer p-10 text-white mt-16 bg-slate-700">
        <nav>
          ...
          <div className="flex gap-2 justify-center">
            ...
            <p className="link link-hover">Manikganj Dhaka</p>
          </div>
          <div className="flex gap-2 justify-center">
            <BiPhoneCall className="text-xl" />
            <p className="link link-hover">+88 01633912193</p>
          </div>
          <div className="flex gap-2 justify-center">
            <AiOutlineMail className="text-xl" />
            <p className="link link-hover">rifatkhan5567790@gmail.com</p>
          </div>
        </nav>
        <nav>
          <h1 className="text-xl  text-center">Services</h1>
          <p className="link link-hover">Gas Line Services</p>
          <p className="link link-hover">Water Line Repair</p>
          <p className="link link-hover">Bathroom Plumbing</p>
          <p className="link link-hover">Basement Plumbing</p>
        </nav>
        <nav>
