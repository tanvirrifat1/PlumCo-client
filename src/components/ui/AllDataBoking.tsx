...
const AllBookingData = ({ serviceId }: DATA) => {
  const { data: service, isLoading } = useGetSingleDataQuery(serviceId);
        ...
        <div className="p-10 shadow-md">
          ...
          <div className="flex gap-3 pt-5">
            ...
            <div className="w-full md:w-1/2">
              ...
              <DatePickerField
                className="appearance-none block cursor-pointer lg:w-[463px] bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
